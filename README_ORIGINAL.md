...
## Advanced Bug Hunting Examples

```bash
# Database leak hunting
chad -q 'intext:"#mysql dump" filetype:sql' -tr 50 -o db_leaks.json

# Admin panel discovery
chad -q 'intitle:admin intitle:login' -tr 100 -o admin_panels.json

# Configuration file hunting
chad -q 'filetype:conf inurl:firewall -intitle:cvs' -tr 75 -o config_files.json

# Log file discovery
chad -q 'filetype:log access.log -CVS' -tr 50 -o log_files.json

# Backup file hunting
chad -q 'filetype:bak inurl:"htaccess|passwd|shadow|htusers"' -tr 50 -o backup_files.json
```
